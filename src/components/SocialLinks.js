...
function SocialLinks({ alignment = 'start' }) {
    return (
        <div className={`flex mt-3 justify-center lg:justify-${alignment}`}>
            ...
            <a href="linkedin.com/in/muthu-kumar-k-1011453a/" target="_blank" rel="noreferrer"  className="mr-3 text-3xl md:text-5xl">
                <ion-icon name="logo-linkedin"></ion-icon>
            </a>


            <a href="https://drive.google.com/file/d/1qcKI-eYrreRg6fdQfCp9B7UYm-rwxUFA/view?usp=sharing/" target="_blank" rel="noreferrer" >
