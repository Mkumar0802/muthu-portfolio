...
function SocialLinks({ alignment = 'start' }) {
    return (
        <div className={`flex mt-3 justify-center lg:justify-${alignment}`}>
            ...
            <a href="https://github.com/Mkumar0802/" target="_blank" className="mr-3 text-3xl md:text-5xl">
                <ion-icon name="logo-github"></ion-icon>
            </a>
            <a href="linkedin.com/in/muthu-kumar-k-1011453a/" target="_blank" className="mr-3 text-3xl md:text-5xl">
