...
{/* <div className="bg-sky-500 p-8 flex flex-row"  >
<div className="sm:text-3xl md:text-5xl">
    <h1 className="px-6 sm:text-3xl md:5xl text-white " > PORTFOLIO  </h1>
</div>

<div className="text-white pt-3 ml-2">
    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
    </svg>
    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div className=" pt-3 text-white ml-2">
    <h3 >+91 9566420177</h3>
    <h3 >mkumar0802@gmail.com</h3>
</div>

<div className="sm:hidden  md:block lg:block ml-40" >
    <nav >
        <ul className="flex flex-row text-white pl-10 ">
            
            <li className="pr-5 mr-3   rounded-lg px-4 py-2  bg-teal-600 hover:bg-teal-700   flex  text-justify">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
</svg>
                <Link to="/">Home </Link>
            ...
            <li className="pr-5 mr-3 rounded-lg px-4 py-2  bg-teal-600 hover:bg-teal-700">
                <Link to="/about">About</Link>
            </li>
            <li className="pr-5 mr-3 rounded-lg px-4 py-2  bg-teal-600 hover:bg-teal-700">
                <Link to="/skill">Skill</Link>
            ...
            <li className="pr-15 mr-3 rounded-lg px-4 py-2  bg-teal-600 hover:bg-teal-700 ">
                <Link to="/contact">Contact</Link>
            </li>
        </ul>
    </nav>
